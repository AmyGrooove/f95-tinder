      ...
      <div className="settingsDefaultFilterLayout">
        <div className="panel settingsDefaultFilterSectionPanel settingsDefaultFilterSortPanel">
          ...
          <div className="formRow" style={{ marginBottom: 0 }}>
            <div className="label">Сортировка latest_data</div>
            <select
              className="input"
          ...
          <>
            <div className="panel">
              <div className="sectionTitleRow">
                ...
                <div className="sectionMeta">
                  Локальный proxy для доступа к F95
                </div>
              </div>
          ...
          <>
            ...
            <div className="panel">
              <div className="sectionTitleRow">
                ...
                <div className="sectionMeta">
                  Локальная карта {"`id -> label`"} для префиксов и движков
                </div>
              </div>

              <div className="settingsSummaryGrid settingsTagStatusGrid">
                <div className="metricCard">
                  <div className="metricLabel">Загружено меток</div>
                  <div className="metricValue settingsMetricValue">
                    {prefixesCount}
                  </div>
                </div>
              ...
              <div className="settingsDataNote">
                ...
                <div className="smallText">
                  Формат:{" "}
                  {`{ "prefixes": { "18": "Completed" }, "engines": { "7": "Ren'Py" } }`}
                </div>
                <div className="smallText">
              ...
              <div className="panel settingsLocalActionPanel">
                ...
                <div className="settingsDataNote">
                  <div className="smallText">
                    ...
                    сохраненные через приложение куки proxy.
                  </div>
                  <div className="smallText">
